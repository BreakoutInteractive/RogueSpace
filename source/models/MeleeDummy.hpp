...
#ifndef MeleeDummy_hpp
#define MeleeDummy_hpp
...
#pragma mark Constructors
     ...
     */
    MeleeDummy(void) : Enemy() { }
    
    /**
     * Destroys this player, releasing all resources.
     */
    virtual ~MeleeDummy(void) { dispose(); }
...
#pragma mark Accessors
    ...
    std::string getType() override { return "melee dummy"; }
