...
//  Version: 3/12/17
//
#ifndef __JS_ROCKET_MODEL_H__
#define __JS_ROCKET_MODEL_H__
#include <cugl/cugl.h>
...
protected:
    ...
    /** The texture filmstrip for the main animation node */
    ...
    /** The texture filmstrip for the right animation node */
    std::string _rightTexture;
...
#pragma mark Animation
     ...
     */
    void setBurnerStrip(Burner burner, const std::string strip);
